...
import 'package:ceiba/framework/failure.model.dart';
import 'package:ceiba/infrastructure/configuration/global.configuration.dart';
...
class HttpDataSource {
  ...
  HttpDataSource(this._basePath, {String? authority})
    : this._authority = authority != null
        ? authority : GlobalCeibaConfiguration.controller.ceibaServer{
  ...
  void _checkAndThrowError(Response response) {
    if (response.statusCode >= HttpStatus.badRequest) {
      final reason = response.reasonPhrase != null ? response.reasonPhrase! : '';
